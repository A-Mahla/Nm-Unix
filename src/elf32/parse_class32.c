...
/*   Updated: 2023/11/11 18:18:35 by amahla ###       ########     ########   */
/*                                                                            */
/* ************************************************************************** */
...
static bool	check_header(long int real_size, Elf32_Ehdr *ehdr);
...
static bool	check_header(long int binary_size, Elf32_Ehdr *ehdr)
{
	long int	size;
